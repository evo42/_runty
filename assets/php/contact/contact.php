<?php
    ...
    // kill spam
    if ( !empty($_POST[ 'ContactForm' ][ 'spam' ]) ) {
        $response = array( 'success'=>false, 'message'=>sprintf($CONFIG['form_errors_msg'], implode('</li><li>', 'Spam sucks.' ) ) );
	...
	$CONFIG = array(
		/* Mail Options */
		'mail_send_to'		=>	'rene.kapusta@aloha-editor.org', 
