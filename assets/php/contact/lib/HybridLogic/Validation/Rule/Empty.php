...
/**
 * Input value must be empty
 *
 * @package Validation
 * @author Rene Kapusta <rene@evo42.net>
 **/
class Empty implements \HybridLogic\Validation\Rule, \HybridLogic\Validation\ClientSide\jQueryValidationRule {
	...
	public function get_error_message($field, $value, $validator) {
		return $validator->get_label($field) . ' must be empty';
