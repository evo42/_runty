...
Aloha.ready(function() {
	Aloha.require( ['aloha', 'aloha/jquery'], function( Aloha, jQuery) {
		...
		Aloha.bind('aloha-editable-deactivated', function() {
			var content = Aloha.activeEditable.getContents(); // this is the cleaned content of the last active editable
			var contentId = Aloha.activeEditable.getId(); // this HTML ID of the DOM element
			var pageId = window.location.pathname; // page URL / ID
